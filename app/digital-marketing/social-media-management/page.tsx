...
const deliverables: { title: string; image: string; bullets: { text: string; Icon: ComponentType<{ className?: string }> }[]; Icon: ComponentType<{ className?: string }> }[] = [
    {
        title: "Content Strategy & Calendars", image: "/deliver/social-calendar.webp", Icon: IconCalendarEvent, bullets: [
    ...
    {
        title: "High-End Visuals & Copy", image: "/deliver/social-visuals.webp", Icon: IconPalette, bullets: [
    ...
    {
        title: "Active Community Management", image: "/deliver/social-community.webp", Icon: IconMessageCircle, bullets: [
    ...
    {
        title: "Growth Analytics", image: "/deliver/social-analytics.webp", Icon: IconTrendingUp, bullets: [
