...
export default function LocalSEOPage() {
 ...
 <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-serif-10 tracking-tight text-ink max-w-3xl">Everything included in your local SEO package.</h2>
                        </div>
 ...
 <h3 className="h3 text-2xl md:text-3xl font-serif tracking-tight text-ink mb-8">Why local businesses choose us.</h3>
                                    </motion.div>
                                    <div className="flex-1 divide-y divide-grid/10">
                                        {whyUsItems.map((item) => (
 ...
 <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-serif-10 tracking-tight text-ink max-w-3xl">From audit to local dominance.</h2>
 ...
 <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif-10 tracking-tighter mb-6">Ready to own your local search results?</h2>
