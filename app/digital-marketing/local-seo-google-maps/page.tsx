...
const deliverables: { title: string; image: string; bullets: { text: string; Icon: ComponentType<{ className?: string }> }[]; Icon: ComponentType<{ className?: string }> }[] = [
    {
        title: "Google Business Profile Mastery", image: "/deliver/seo-google-maps.webp", Icon: IconMapPin, bullets: [
    ...
    {
        title: "Local Keyword Dominance", image: "/deliver/seo-keywords.webp", Icon: IconSearch, bullets: [
    ...
    {
        title: "Review Generation Systems", image: "/deliver/seo-reviews.webp", Icon: IconStar, bullets: [
    ...
    {
        title: "AI-Optimized Local Search", image: "/deliver/seo-ai.webp", Icon: IconRobot, bullets: [
...
export default function LocalSEOPage() {
 ...
 <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-serif tracking-tight text-ink max-w-3xl">Everything included in your local SEO <em className="font-serif-10 italic">package.</em></h2>
                        </div>
 ...
 <h3 className="h3 text-2xl md:text-3xl font-serif tracking-tight text-ink mb-8">Why local businesses choose <em className="font-serif-10 italic">us.</em></h3>
                                    </motion.div>
                                    <div className="flex-1 divide-y divide-grid/10">
                                        {whyUsItems.map((item) => (
 ...
 <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-serif tracking-tight text-ink max-w-3xl">From audit to local <em className="font-serif-10 italic">dominance.</em></h2>
