...
export const metadata = buildPageMetadata({
    title: "Premium Static Websites | High-Speed, Zero Upfront Monthly Plan",
    description:
        "Get a high-performing premium static website with zero upfront costs. Pay-monthly plans with SEO foundations, fast launch times, and ongoing performance support.",
