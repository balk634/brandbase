...
const deliverables: { title: string; bullets: { text: string; Icon: ComponentType<{ className?: string }> }[]; Icon: ComponentType<{ className?: string }> }[] = [
    {
        title: "Identity & Discovery", Icon: IconTargetArrow, bullets: [
    ...
    {
        title: "Performance & SEO", Icon: IconBolt, bullets: [
    ...
    {
        title: "Marketing & Engagement", Icon: IconMail, bullets: [
    ...
    {
        title: "Tech & Hosting", Icon: IconCloud, bullets: [
    ...
    {
        title: "Peace of Mind", Icon: IconHeartHandshake, bullets: [
    ...
    {
        title: "Design & Branding", Icon: IconPalette, bullets: [
                            ...
                            <div className="grid lg:grid-cols-2">
                                ...
                                <div className="p-7 md:p-10 flex flex-col">
                                    <motion.div variants={fadeInUp}>
                                        ...
                                        <h3 className="text-2xl md:text-3xl font-sans font-bold tracking-tight text-ink mb-8">Why small businesses love this model.</h3>
                                    </motion.div>
                                    <div className="flex-1 divide-y divide-grid/10">
                                        {whyUsItems.map((item) => (
