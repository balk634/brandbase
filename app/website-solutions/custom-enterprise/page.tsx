...
const deliverables: { title: string; bullets: { text: string; Icon: ComponentType<{ className?: string }> }[]; Icon: ComponentType<{ className?: string }> }[] = [
    {
        title: "Brand & Design", Icon: IconCrown, bullets: [
    ...
    {
        title: "Traffic & Analytics", Icon: IconFlame, bullets: [
    ...
    {
        title: "Leads & Bookings", Icon: IconTimeline, bullets: [
    ...
    {
        title: "Infrastructure & CMS", Icon: IconNetwork, bullets: [
    ...
    {
        title: "Support & Guarantee", Icon: IconShieldCheck, bullets: [
    ...
    {
        title: "Email & Marketing", Icon: IconMailFast, bullets: [
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                            <div>
                                <motion.div variants={fadeInLeft}>
                                    <Kicker className="text-xs md:text-sm px-6 py-2.5 bg-primary/5 border-primary/30 text-primary"> CUSTOM WEBSITES </Kicker>
                                </motion.div>
                                <motion.h1 variants={fadeInLeft} className="mt-8 text-3xl sm:text-4xl md:text-6xl font-sans font-bold leading-[0.95] tracking-tighter text-ink">
                                    Custom Websites <span className="text-primary">Built to Scale.</span>
                                </motion.h1>
                ...
                <Container>
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer}>
                        <div className="mb-16 md:mb-20">
                            ...
                            <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-bold font-sans tracking-tight text-ink max-w-3xl">Everything included in your custom build.</h2>
                        </div>
                            ...
                            <div className="grid lg:grid-cols-2">
                                ...
                                <div className="p-7 md:p-10 flex flex-col">
                                    <motion.div variants={fadeInUp}>
                                        ...
                                        <h3 className="text-2xl md:text-3xl font-sans font-bold tracking-tight text-ink mb-8">Why growing businesses choose us.</h3>
                                    </motion.div>
                                    <div className="flex-1 divide-y divide-grid/10">
                                        {whyUsItems.map((item) => (
                ...
                <Container>
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerSlow}>
                        <div className="mb-16">
                            ...
                            <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-bold font-sans tracking-tight text-ink max-w-3xl">From brief to live website.</h2>
                            ...
                            <div className="grid lg:grid-cols-2">
                                <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-grid/15">
                                    <motion.div variants={fadeInUp}>
                                        ...
                                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-sans font-bold tracking-tighter mb-6">Ready to build something that actually works?</h2>
