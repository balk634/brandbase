...
export default function CustomEnterprisePage() {
 ...
 <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-serif-10 tracking-tight text-ink max-w-3xl">Everything included in your custom build.</h2>
                        </div>
 ...
 <h3 className="h3 text-2xl md:text-3xl font-serif tracking-tight text-ink mb-8">Why growing businesses choose us.</h3>
                                    </motion.div>
                                    <div className="flex-1 divide-y divide-grid/10">
                                        {whyUsItems.map((item) => (
 ...
 <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-serif-10 tracking-tight text-ink max-w-3xl">From brief to live website.</h2>
 ...
 <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif-10 tracking-tighter mb-6">Ready to build something that actually works?</h2>
