...
export const metadata = buildPageMetadata({
    title: "Ecommerce Website Development | Nodecraft",
    description:
                ...
                <Container>
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer}>
                        <div className="mb-16 md:mb-20">
                            ...
                            <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-bold font-sans tracking-tight text-ink max-w-3xl">Everything your store needs to launch and grow.</h2>
                        </div>
                            ...
                            <div className="grid lg:grid-cols-2">
                                ...
                                <div className="p-7 md:p-10 flex flex-col">
                                    <motion.div variants={fadeInUp}>
                                        ...
                                        <h3 className="text-2xl md:text-3xl font-sans font-bold tracking-tight text-ink mb-8">Why brands trust us with their store.</h3>
                                    </motion.div>
                                    <div className="flex-1 divide-y divide-grid/10">
                                        {whyUsItems.map((item) => (
                ...
                <Container>
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerSlow}>
                        <div className="mb-16">
                            ...
                            <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-bold font-sans tracking-tight text-ink max-w-3xl">From idea to live store.</h2>
